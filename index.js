...
// ★★★ Daily Insight用: 「アグリ」「Agri」を削除し、より具体的なキーワードのみに厳格化 ★★★
const PRIMARY_INDUSTRY_KEYWORDS = [
  '農業', '農家', '農産物', '農地', '農場', '農作物', '農法', '農園', '畜産', '漁業', '林業', '酪農', '栽培', '養殖',
  'スマート農業', '有機農業', 'フードテック', '農林水産', '一次産業', '圃場', '収穫', '品種', 'JGAP',
  '農業経営', '新規就農', '認定農業者', '農業法人', 'JA', '農協', '農業技術', '農業生産', '農作業'
];
...
// ★★★ 「アグリ」「Agri」を削除し、より具体的なキーワードのみに厳格化 ★★★
const CORE_AGRI_KEYWORDS =  [
  // 基本（農業の明確な単語のみ）
  '野菜', '農業', '農家', '農産物', '農地', '農場', '農作物', '農法', '農園', '畑', '田んぼ', '水田', '果樹園',
  '畜産', '漁業', '林業', '酪農', '栽培', '養殖', '収穫', '品種', '圃場', '水産', '牧場', '養鶏', '養豚',
  // 新農法・技術
  '乾田直播', '不耕起', 'リジェネラティブ農業', '環境再生型', '陸上養殖', '植物工場', 'バイオ炭', 'バイオスティミュラント',
  'スマート農業', '有機農業', '自然農法', '露地栽培', 'ハウス栽培', '水耕栽培'
];
