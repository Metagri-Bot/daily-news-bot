...
- Google Newsの中継URLだけで元記事の公開日が確認できない候補は採用しません。同記事を媒体から直接取得できた場合はそちらを審査します。このため投稿候補が減る場合があります。
...
- 本文未取得時の推測は禁止し、「概要のみ確認」と明記。過去施策のKPIを今回の成果に転用しません。公開日を確認できないGoogle News中継リンクは投稿対象外です。
