...
| **千葉県自治体案件レーダー** | 火・金 8:30 | 千葉県＋近隣6市の企画提案（プロポーザル）を収集し、100点評価して通知＋締切リマインド |
...
```
🔎 千葉県レーダー｜9/1(火) 08:30 巡回：7ソース／収穫57件／精査40件／通知該当0件
```
...
| `CHIBA_TENDER_CRON` | 千葉県レーダーの実行スケジュール（既定 `30 8 * * 2,5`＝火・金8:30） |
...
├── chiba-tender-radar.js       # 千葉県レーダー: 実行本体（火・金8:30）
...
| 8:30（火・金） | **千葉県自治体案件レーダー** | `30 8 * * 2,5` |
